    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="profile.html"><img src="img/<?php echo $_SESSION['username']['img']; ?>" class="img-circle" width="80"></a></p>
                ...
                <div class="message-p pn">
                  ...
                  <div class="row">
                    <div class="col-md-3 centered hidden-sm hidden-xs">
                      <img src="img/<?php echo $_SESSION['username']['img']; ?>" class="img-circle" width="65">
                    </div>
                    <div class="col-md-9">
                      <p>
